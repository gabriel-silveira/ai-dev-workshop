...
2. Invoque o agente `code-reviewer` para revisar o código e garantir que está bom para lançar.
3. Invoque o agente `documentation-writer` para atualizar a documentação do projeto.
4. Invoque o agente `test-planner-branch` para finalizar a escrita de testes para a branch.
